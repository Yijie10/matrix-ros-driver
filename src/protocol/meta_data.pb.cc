...
void protobuf_AssignDesc_meta_5fdata_2eproto() {
  ...
  static const int StructurePerception_offsets_[6] = {
  ...
  DataDescriptor_descriptor_ = file->message_type(3);
  static const int DataDescriptor_offsets_[1] = {
...
void protobuf_AddDesc_meta_5fdata_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "meraMatrix\022%\n\006sensor\030\024 \001(\0132\025.MetaData.Se"
    ...
    "n\030\036 \001(\0132\035.MetaData.StructurePerception**"
      ...
      case 1: {
        if (tag == 8) {
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          if (::MetaData::DataType_IsValid(value)) {
            set_type(static_cast< ::MetaData::DataType >(value));
          } else {
